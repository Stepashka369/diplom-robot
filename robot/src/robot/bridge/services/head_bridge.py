...
class HeadBridge(Node):
    def __init__(self, rotation_percent: HeadRotation):
        ...
        self.move_to_position(rotation_angle_percent=rotation_percent)


    def move_to_position(self, rotation_angle_percent: HeadRotation):
        position_rad = self.calculate_rad(rotation_angle_percent.rotation_percent)
        self.get_logger().info("Head angle to move: {}".format(position_rad))
